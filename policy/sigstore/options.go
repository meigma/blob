...
func WithTrustedRoot(tr root.TrustedMaterial) PolicyOption {
...
func WithTrustedRootFile(path string) PolicyOption {
	return func(p *Policy) error {
...
func WithIdentity(issuer, subject string) PolicyOption {
	return func(p *Policy) error {
